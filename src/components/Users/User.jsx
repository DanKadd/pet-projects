...
export const User = ({id, last_name, first_name, avatar, email, onClickInvited, isInvited}) => {
  ...
  return (
    <li>
      ...
      <img onClick={() => onClickInvited(id)} className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
    </li>
  )
};
